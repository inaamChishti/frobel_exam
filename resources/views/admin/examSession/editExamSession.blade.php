    ...
    <div class="row justify-content-center mt-2">
        <div class="col-md-6">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{url('updateExamSession')}}">
                        @csrf
                        <div class="mb-3">
                            <label for="examSession" class="form-label">Exam Session</label>
                            <input type="text" class="form-control" value="{{@$exams->exam_session}}" name="examSession" id="examSession" placeholder="Enter Exam Session">
                            <input type="hidden" class="form-control" value="{{@$exams->id}}" name="id" id="id" >
                        </div>
